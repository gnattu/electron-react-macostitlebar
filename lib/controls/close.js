...
class Close extends _react.Component {
  render() {
    const { currentWindow, isFocused } = this.props;
    const classOnFocus = isFocused ? 'macos-close-btn-focused' : '';
    return _react2.default.createElement(
      'a',
      { className: `${classOnFocus} macos-close-btn macos-control-btn`, onClick: () => currentWindow.close() },
