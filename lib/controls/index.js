...
const Controls = exports.Controls = ({ isFullscreen, isFocused, disableMinimize, disableFullscreen, currentWindow, showOnHover, style }) => !isFullscreen && _react2.default.createElement(
  'div',
  { className: 'macos-window-control', style: style },
