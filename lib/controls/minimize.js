...
const Minimize = exports.Minimize = ({ currentWindow, isFocused, disabled }) => {
  const classOnFocus = isFocused ? 'macos-minimize-btn-focused' : '';
  if (disabled) {
    return _react2.default.createElement('a', { className: 'macos-control-btn' });
  } else {
    return _react2.default.createElement(
      'a',
      { className: `${classOnFocus} macos-minimize-btn macos-control-btn`, onClick: () => currentWindow.minimize() },
